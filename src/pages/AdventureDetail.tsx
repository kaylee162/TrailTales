  ...
  return (
    <article>
      ...
      <section className="scrapbook-card overflow-hidden bg-paper">
        <img src={photo} alt={adventure.title} className="h-[360px] w-full object-cover" />
